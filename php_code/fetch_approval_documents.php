...
>>>>>>> main
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<button type='button' class='btn btn-sm btn-info comment-btn mt-2' data-document-id='" . $documentId . "'>คอมเมนต์</button>";
                echo "<button type='button' class='btn btn-sm btn-success mt-2 approve-btn' data-id='" . $documentId . "'>อนุมัติ</button>";
                echo "<button type='button' class='btn btn-sm btn-danger mt-2 return-btn' data-id='" . $documentId . "'>ตีกลับ</button>";
