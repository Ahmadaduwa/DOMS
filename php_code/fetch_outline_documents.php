...
if (isset($_POST['cardId'])) {
    ...
    if (isset($_SESSION['number'])) {
        ...
        $sql = "SELECT * FROM documents WHERE returned = 2 AND owner = ?";
                        ...
                        echo "<div class='card-details' style='flex: 1;'>";
                            ...
                            echo "<div class='cont'>";
                                echo "<div class='left'>";
                                    ...
                                    echo "<p class='card-text'><strong>From:</strong> " . htmlspecialchars($row['start_date']) . " <strong>To:</strong> " . htmlspecialchars($row['end_date']) . "</p>";
                                    ...
                                    if (count($files) > 0) {
                                        ...
                                        foreach ($files as $file) {
                                            echo "<a href='" . htmlspecialchars($file) . "' target='_blank'>" . htmlspecialchars(basename($file)) . "</a><br>";
                                        }
                                        echo "</p>";
                                    } else {
